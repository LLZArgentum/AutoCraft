...
import net.llz.autocraft.block.BasicHeatFlowSupplyTankBlock;
...
public class AutocraftModBlocks {
	...
	public static final DeferredBlock<Block> BASIC_HEAT_FLOW_SUPPLY_TANK;
	static {
		...
		BASIC_HEAT_FLOW_SUPPLY_TANK = REGISTRY.register("basic_heat_flow_supply_tank", BasicHeatFlowSupplyTankBlock::new);
	}
